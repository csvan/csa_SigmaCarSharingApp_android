...
public class DetailActivity extends AppCompatActivity {
    ...
    tvStartDate.setText("Date from: " + booking.getStarting_date());
    tvEndDate.setText(" to "+ booking.getEnding_date());
    tvStartTime.setText("Time from:" + booking.getStarting_time());
    tvEndTime.setText("to " + booking.getEnding_time() +".");
